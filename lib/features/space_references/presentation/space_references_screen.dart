  ...
  Future<void> _submitCreate() async {
    ...
    if (result.isCreated) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Referencia criada e pronta para uso.')),
      );
      return;
    }
    ...
    if (result.isDuplicateSuggestion) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Ja existe uma referencia parecida no seu Espaco.'),
        ),
      );
    }
  }
                ...
                children: [
                  Card(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Use o que ja existe antes de criar algo novo',
                            style: theme.textTheme.titleLarge,
                          ),
                          const SizedBox(height: 8),
                          Text(
                            'Seu Espaco fica mais organizado quando voce reaproveita referencias parecidas e cria novas so quando fizer sentido.',
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          Text(
                            'Comece olhando o que ja esta disponivel no seu Espaco.',
                            style: theme.textTheme.bodyMedium?.copyWith(
                              color: const Color(0xFF65727B),
                            ),
                          ),
                  ...
                  if (_viewModel.isLoading) ...[
                    ...
                    const _StateCard(
                      ...
                      message:
                          'Ainda nao ha referencias no seu Espaco com esse filtro. Voce pode criar a primeira logo abaixo.',
                    ),
                  ] else ...[
                    ...
                    child: Padding(
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Criar nova referencia',
                              style: theme.textTheme.titleMedium,
                            ),
                            const SizedBox(height: 8),
                            Text(
                              'Se nao encontrar o que voce precisa, crie uma referencia nova em poucos passos.',
                              style: theme.textTheme.bodyMedium?.copyWith(
                                color: const Color(0xFF65727B),
                              ),
                            ),
                            ...
                            TextFormField(
                              ...
                              validator: (value) {
                                ...
                                if (trimmed.isEmpty) {
                                  return 'Informe o nome da referencia.';
                                }
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Referencia em uso agora', style: theme.textTheme.titleMedium),
            const SizedBox(height: 8),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              result.message ??
                  'Ja existe uma referencia parecida no seu Espaco.',
            ),
            const SizedBox(height: 12),
            Text(
              suggestion.name,
            ...
            FilledButton.icon(
              ...
              icon: const Icon(Icons.check_circle_outline),
              label: const Text('Usar referencia encontrada'),
            ),
          ],
        ),
      ),
