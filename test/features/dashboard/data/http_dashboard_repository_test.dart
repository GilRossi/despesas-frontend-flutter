...
void main() {
  test('fetchDashboard consome o contrato unico do dashboard role-aware', () async {
    ...
    expect(result.monthOverview?.highestSpendingCategory?.categoryName, 'Moradia');
    expect(result.categorySpending?.items.first.categoryName, 'Moradia');
    expect(result.householdSummary?.referencesByGroup.first.group.apiValue, 'RESIDENCIAL');
