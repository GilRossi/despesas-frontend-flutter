...
DriverNativeFoundationStatus fakeDriverNativeFoundationStatus({
  ...
  bool structuredOfferPresent = false,
  DriverStructuredOfferStatus? structuredOffer,
  String? offerClassification,
  bool offerActionable = false,
  List<String> offerMissingFields = const [],
  String? offerParsingConfidence,
  bool offerSignalPresent = false,
  DriverOfferSignalStatus? offerSignal,
  String? offerSignalColor,
  ...
  return DriverNativeFoundationStatus(
    ...
    lastOffer: lastOffer,
    structuredOfferPresent: structuredOfferPresent,
    structuredOffer: structuredOffer,
    offerClassification: offerClassification,
    offerActionable: offerActionable,
    offerMissingFields: offerMissingFields,
    offerParsingConfidence: offerParsingConfidence,
    offerSignalPresent: offerSignalPresent,
    offerSignal: offerSignal,
    offerSignalColor: offerSignalColor,
